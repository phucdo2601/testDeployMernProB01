...
const EditListing = () => {
    ...
    const handleRemoveImage = (index) => {
        setFormData({
            ...formData,
            imageUrls: formData.imageUrls((_, i) => i !== index),
        })
    }
        ...
        '>
                ...
                '>
                    ...
                    '>
                        ...
                        <div className="flex flex-wrap gap-6">
                            <div className="flex items-center gap-2">
                                <input type="number" id="bedrooms" min={`1`} max={`10`} required className='
                            ...
                            <div className="flex items-center gap-2">
                                <input type="number" id="bathrooms" min={`1`} max={`10`} required className='
                                p-3 border border-gray-300 rounded-lg 
                            ' onChange={handleChange}
                            ...
                            <div className="flex items-center gap-2">
                                <input type="number" id="regularPrice" min='50'
                                    max='10000000' required className='
                                p-3 border border-gray-300 rounded-lg 
                            ' onChange={handleChange}
                    ...
                    ">
                        ...
                        <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80' type='submit'>
                            {
